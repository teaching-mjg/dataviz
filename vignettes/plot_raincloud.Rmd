...
ggplot(data_ldt, aes(x = "", y = rt, fill = language)) +
  ...
  labs(title="Reaction time distributions for the lexical decision task from monolingual and bilingual readers", 
       subtitle = "Bilinguals are slower than monolinguals to correctly identify non-words but not to identify real words")
